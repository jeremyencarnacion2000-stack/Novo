...
const translations: Record<Language, Record<string, string>> = {
    ...
    de: {
        ...
        'sidebar.life_context': 'Lebenskontext',
        'sidebar.cognitive_engine': 'Kognitive Engine',
        'sidebar.dashboard': 'Dashboard',
        'sidebar.today': 'Heute',
        ...
        'sidebar.focus': 'Fokus',
        'sidebar.routines': 'Routinen',
        'sidebar.checklist': 'Checkliste',
        'sidebar.projects': 'Projekte',
        'sidebar.trackers': 'Tracker',
        'sidebar.school': 'Schule',
        'sidebar.business': 'Business',
        'sidebar.library': 'Bibliothek',
        'sidebar.spiritual': 'Spirituell',
        'sidebar.social': 'Sozial',
        'sidebar.appearance': 'Erscheinungsbild',
        'sidebar.music': 'Musik',
        'sidebar.connectors': 'Konnektoren',
        'sidebar.notes': 'Notizen',
        'sidebar.pinned': 'Favoriten',
