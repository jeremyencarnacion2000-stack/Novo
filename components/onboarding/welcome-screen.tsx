...
const slides = [
    {
        ...
        description: "An adaptive Cognitive Operating System that calibrates itself to your brain's natural rhythms, energy peaks, and focus patterns.",
        icon: LayoutDashboard,
        features: [
            { icon: CheckCircle2, text: "Smart biometric calibration" },
            { icon: Timer, text: "Rhythm & energy tracking" },
        ],
    ...
    },
    {
        ...
        description: "A contextual companion that tracks your decision fatigue, cognitive load, and schedules deep work when your mind is sharpest.",
        icon: Sparkles,
        features: [
            { icon: Brain, text: "Context-aware telemetry" },
            { icon: Sparkles, text: "Cognitive load analysis" },
        ],
    ...
    },
    {
        ...
        features: [
            ...
            { icon: Timer, text: "Biometric Pomodoro timer" },
        ],
