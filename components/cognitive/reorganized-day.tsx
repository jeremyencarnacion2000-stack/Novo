...
import { ArrowRight, ChevronDown, ChevronUp, Zap } from 'lucide-react';
  ...
  return (
    <div>
      <div className="flex items-center gap-2.5 mb-5">
        ...
        <span className="ml-auto text-[10px] text-white/20 font-medium">{tasks.length} tasks</span>
      </div>
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Index badge */}
                <span
                  className="w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black text-white/30 flex-shrink-0 border border-white/[0.08]"
                ...
                {/* Time block */}
                <div
                  className="flex flex-col items-center justify-center flex-shrink-0 w-12 py-1 rounded-lg border border-transparent group-hover:border-white/[0.06] transition-all duration-300"
                ...
                >
                  ...
                  <span className="text-[7px] text-white/25 font-semibold tracking-wide leading-none mt-1">
                ...
                {/* Task title */}
                <span className="flex-1 text-[13px] font-semibold text-white/80 truncate group-hover:text-white/90 transition-colors">
                  {task.title}
                </span>
                ...
                {isExpanded
                  ...
                  : <ChevronDown className="w-3.5 h-3.5 text-white/20 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" />
                }
              </button>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-[11px] text-white/45 leading-relaxed">{task.reason}</p>
                      </div>
                    </div>
                  </motion.div>
                )}
