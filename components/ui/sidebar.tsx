    ...
    >
      ...
      >
        <div
          ...
          className="bg-[rgba(255,255,255,var(--glass-opacity))] backdrop-blur-[calc(var(--glass-blur,20)*1px)] saturate-[160%] border-r border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-[28px] group-data-[variant=floating]:border group-data-[variant=floating]:shadow-xl"
        >
          {children}
        </div>
      </div>
