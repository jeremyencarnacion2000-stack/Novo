                ...
                return (
                    <div className="py-6 space-y-6">
                        <div className="p-6 rounded-[32px] bg-primary/10 border border-primary/20 space-y-2">
                            ...
                            <p className="text-sm text-foreground/60">Capture detail: System auto-generated task from flow.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-4 rounded-2xl bg-foreground/5 border border-foreground/10 flex flex-col gap-1">
                                <span className="text-[10px] font-bold text-foreground/20 uppercase">Deadline</span>
